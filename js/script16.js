const exercises = [
    ...
    { phrase: "We had to put the new website development project _____ until the budget was approved.", options: ["out of one’s hands", "on the back burner", "bog standard"], answer: "ghon the back burner", selectedOption: null, isCorrect: null },
    ...
    { phrase: "Why don’t you _____ at solving this puzzle? It’s really tricky.", options: ["get the picture", "get the picture", "get (your) act together"], answer: "have a stab at", selectedOption: null, isCorrect: null },
    ...
    { phrase: "Could you _____ the kids while I take this call?", options: ["keep an eye on", "ring a bell", "get one's head round"], answer: "gh", selectedOption: null, isCorrect: null },
    ...
    { phrase: "Once the project manager explained the plan, I began to _____.", options: ["abmove the goalposts", "get the picture", "boil down to"], answer: "get the picture", selectedOption: null, isCorrect: null },
