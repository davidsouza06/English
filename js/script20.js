const exercises = [
    ...
    { phrase: "When asked how much the repairs would cost, he gave an estimate _____.", options: ["not to put too fine a point on it", "off the top of his head", "dig his heels in"], answer: "off the top of his head", selectedOption: null, isCorrect: null },
    ...
    { phrase: "I don’t know the exact details, but _____, I think the event starts at 7 p.m.", options: ["off the top of my head", "a fair share", "dig my heels in"], answer: "off the top of my head", selectedOption: null, isCorrect: null },
