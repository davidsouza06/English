const exercises = [
    { phrase: "good old days ____", answers: ["a nostalgic reference to a past period seen as better"] },
    { phrase: "grey area ____", answers: ["a situation or topic that is not clearly defined"] },
    { phrase: "out of the blue ____", answers: ["unexpectedly, without warning"] },
    { phrase: "golden age ____", answers: ["a period of great success, prosperity, or achievement"] },
    { phrase: "touchy-feely ____", answers: ["loving and kind, especially through physical contact"] },
    { phrase: "spring to mind ____", answers: ["to suddenly think of something"] },
    { phrase: "have a stab at ____", answers: ["to try or attempt something"] },
    { phrase: "get the picture ____", answers: ["to understand a situation"] },
    { phrase: "the high point ____", answers: ["the most enjoyable or significant part of an event"] },
    { phrase: "do the job ____", answers: ["to be effective or successful"] }
] 

const exercises2 = [
    { phrase: "move the goalposts ____", answers: ["change rules to make it more difficult to achieve a thing"] },
    { phrase: "behind the scenes ____", answers: ["happening without being known or seen by the public"] },
    { phrase: "on the back burner ____", answers: ["delayed or postponed for future consideration"] },
    { phrase: "bog standard ____", answers: ["completely ordinary or unremarkable"] },
    { phrase: "out of one's hands ____", answers: ["beyond one's control or responsibility"] },
    { phrase: "call the cavalry ____", answers: ["call for help from people in authority / with power"] },
    { phrase: "beg the question ____", answers: ["to raise a question or point that needs to be addressed"] },
    { phrase: "get (something) straight ____", answers: ["to clarify or understand something correctly"] },
    { phrase: "boil down to ____", answers: ["the essential or most important aspect of something"] },
    { phrase: "get (one's) act together ____", answers: ["to organise oneself or one's affairs to achieve something"] }
]
...
function toggleTranslation() {
    ...
    if (isTranslated) {
        exerciseText.innerHTML = `Exercise 15: Match the idioms with the definition`;
    } else {
        exerciseText.innerHTML = `Exercício 15: Combine as expressões idiomáticas com a definição`;
    }
