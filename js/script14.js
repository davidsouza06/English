const exercises = [
    ...
    { phrase: "This course will be a _____ for you to get into a more advanced program next year.", options: ["ring a bell", "stepping stone", "last resort"], answer: "stepping stone", selectedOption: null, isCorrect: null },
    ...
    { phrase: "The cost of housing in this area has _____ over the last few years.", options: ["gotten to grips with", "cast one's mind back", "gone through the roof"], answer: "gone through the roof", selectedOption: null, isCorrect: null },
    ...
    { phrase: "_____ did you manage to finish the project so quickly?", options: ["How on earth", "That's another story", "Bear with me"], answer: "How on earth", selectedOption: null, isCorrect: null },
    { phrase: "I find it hard to _____ the logic behind this new policy; it just doesn’t make sense to me.", options: ["get my head around", "bear with me", "get to grips with"], answer: "get my head around", selectedOption: null, isCorrect: null },
